...
const sampleNotices = [
  ...
  },
  {
    ...
    writer: '박상준',
    content:
      '공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4 공지사항 테스트 넘버 4',
  },
  {
    id: 5,
    isPinned: false,
